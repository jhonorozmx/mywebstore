...
const OrderScreen = (props) => {
  ...
  }, [dispatch, orderId, order, sdkReady, paymentSuccess]);
            ...
            <li>
              <div className="card card-body">
                ...
                {order.isDelivered ? (
                  ...
                  <MessageBox type="error">Not Delivered</MessageBox>
                )}
              </div>
            </li>
            <li>
              <div className="card card-body">
                ...
                {order.isPaid ? (
                  ...
                  <MessageBox type="error">Not Paid</MessageBox>
                )}
              </div>
            </li>
            <li>
              ...
              {!order.isPaid && (
                <li>
                  {!sdkReady ? (
                    ...
                    <>
                      {paymentError && (
                        <MessageBox type="error">{paymentError}</MessageBox>
                      )}
