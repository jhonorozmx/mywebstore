...
import { ProductsGetByOwner } from "./productController/ProductsGetByOwner";
...
export const productsGetByOwner = new ProductsGetByOwner(productService);
export const productsSeedController = new ProductsSeedController(
  productService
);
export const productsCreateController = new ProductsCreateController(
  productService
);
export const productsUpdateController = new ProductsUpdateController(
  productService
);
export const productsDeleteController = new ProductsDeleteController(
  productService
);
...
export const salesGetByUserController = new SalesGetByUserController(
  saleService
);
